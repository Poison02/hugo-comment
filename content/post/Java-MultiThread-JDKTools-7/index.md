---
title: "Java MultiThread JDKTools 7"
date: 2023-07-14T20:45:31+08:00
draft: false
tags: ['Java', '多线程']
category: '学习之路'
---
...
![fork/join流程图](./assets/fork_join流程图.png)
...
![工作窃取算法流程](./assets/工作窃取算法运行流程图.png)
...
我们在之前介绍过说Thread.join()会使线程阻塞，而ForkJoinPool.join()会使线程免于阻塞，下面是ForkJoinPool.join()的流程图：![join流程图](./assets/join流程图.png)
